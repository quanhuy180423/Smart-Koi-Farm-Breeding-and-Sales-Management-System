...
import { useAddArea, useArea, useDeleteArea, useUpdateArea } from "@/hooks/useArea"; // import hook bạn vừa tạo
import {
    Card,
    CardContent,
    CardDescription,
...
export default function AreaManagement() {
    ...
    const { isPending: isEditting, mutateAsync: updateAreaAsync } = useUpdateArea();
    const { isPending: isDeleting, mutateAsync: deleteAreaAsync } = useDeleteArea();

    const filteredAreas = areasFromApi?.result?.filter((area) =>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) => setNewArea({ ...newArea, totalAreaSQM: e.target.value })}
                                />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setEditingArea({ ...editingArea, areaName: e.target.value })
                                        }
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setEditingArea({ ...editingArea, totalAreaSQM: parseFloat(e.target.value) })
                                        }
                                    />
                                </div>
                            </div>
            ...
            <Dialog open={isDetailModalOpen} onOpenChange={setIsDetailModalOpen}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>Thông tin chi tiết của khu vực</DialogDescription>
                    </DialogHeader>
                    {selectedArea && (
                        <div className="space-y-4">
                            <p><strong>Tên khu vực:</strong> {selectedArea.areaName}</p>
                            <p><strong>Diện tích:</strong> {selectedArea.totalAreaSQM} m²</p>
                            <p><strong>Mô tả:</strong> {selectedArea.description}</p>
