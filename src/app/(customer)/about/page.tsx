            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Giao diện thân thiện, dễ hiểu, phù hợp với mọi đối tượng
                    người dùng.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Hệ thống bảo mật đa tầng, đảm bảo an toàn cho dữ liệu khách
                    hàng.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Giải pháp tối ưu về chi phí, mang lại lợi nhuận cao cho
                    khách hàng.
                  </p>
                </div>
              </div>
