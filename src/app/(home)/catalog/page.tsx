    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setFilters((prev) => ({ ...prev, selectedGender: value }))
          }
        >
...
export default function CatalogPage() {
  ...
  const filterParams = useMemo((): KoiFishSearchParams => {
    ...
    if (varietyIdFromUrl && !isNaN(Number(varietyIdFromUrl))) {
      params.varietyId = Number(varietyIdFromUrl);
    }
  ...
  const handleAddToCart = (koiFishId: number) => {
    addToCard({ koiFishId, quantity: 1 });
  };
