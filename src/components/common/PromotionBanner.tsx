        ...
        <div className="flex items-center justify-center gap-2">
          ...
          {daysUntilExpiry <= 7 && (
            <>
              ...
              <Badge
                variant="secondary"
                className="bg-white/20 text-white border-0 text-[10px] px-2 py-0.5"
              >
        ...
        <div className="grid lg:grid-cols-5 gap-0 relative">
          ...
          <div className="lg:col-span-2 p-4 lg:p-6 flex flex-col justify-between bg-linear-to-br from-background to-muted/20">
            <div className="space-y-4">
              ...
              <div
                className={`${daysUntilExpiry <= 7 ? "grid grid-cols-3 gap-3" : "grid grid-cols-2 gap-3"}`}
              >
                {daysUntilExpiry <= 7 && (
            ...
            <div className="space-y-3 pt-4 mt-4 border-t border-border">
              <Link href="/catalog" className="block">
                <Button className="w-full cursor-pointer bg-linear-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group h-10 text-sm">
