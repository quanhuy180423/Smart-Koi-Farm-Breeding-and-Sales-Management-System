          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ref={menuButtonRef}
                type="button"
                className="lg:hidden p-2 hover:bg-primary/10 rounded-md transition-colors duration-200"
          ...
          >
            <div className="container mx-auto px-4 py-6">
              <nav className="flex flex-col space-y-1">
                <Link
                  href="/"
                  className="px-4 py-3 text-base font-medium text-secondary-foreground hover:text-primary hover:bg-primary/5 rounded-lg transition-all duration-200"
                  onClick={closeMobileMenu}
                >
                  Trang chủ
                </Link>
                ...
                {isAuthenticated ? (
                  <>
                    <Button
                      ...
                      className="w-full justify-center bg-linear-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground font-medium h-12 text-base"
                    >
                    ...
                    <Button
                      variant="outline"
                      className="w-full justify-center h-12 text-base border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground"
                      onClick={async () => {
                        await useAuthStore.getState().logout();
                        closeMobileMenu();
                        router.push("/login");
                  ...
                  <div className="flex flex-col gap-3">
                    <Link
                      ...
                      className="w-full"
                    >
                      <Button className="w-full justify-center bg-linear-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-primary-foreground font-medium h-12 text-base">
                        <User className="w-5 h-5 mr-2" />
                        Đăng nhập
                      </Button>
                    </Link>
